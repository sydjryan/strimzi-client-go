...
type KafkaBridgeMetadata map[string]string
...
// The Kafka AdminClient configuration used for AdminClient instances created by
// the bridge.
type KafkaBridgeSpecAdminClientConfig map[string]string
...
// ssl.endpoint.identification.algorithm, ssl.cipher.suites, ssl.protocol,
// ssl.enabled.protocols).
type KafkaBridgeSpecConsumerConfig map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaBridgeSpecHttp) UnmarshalJSON(b []byte) error {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaBridgeSpecJvmOptions) UnmarshalJSON(b []byte) error {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaBridgeSpecLivenessProbe) UnmarshalJSON(b []byte) error {
...
// ssl.endpoint.identification.algorithm, ssl.cipher.suites, ssl.protocol,
// ssl.enabled.protocols).
type KafkaBridgeSpecProducerConfig map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaBridgeSpecReadinessProbe) UnmarshalJSON(b []byte) error {
...
type KafkaBridgeSpecResourcesLimits map[string]string

type KafkaBridgeSpecResourcesRequests map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaBridgeSpecTemplatePodDisruptionBudget) UnmarshalJSON(b []byte) error {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaBridgeSpecTemplatePod) UnmarshalJSON(b []byte) error {
