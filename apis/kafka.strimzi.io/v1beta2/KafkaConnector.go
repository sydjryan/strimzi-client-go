...
type KafkaConnectorMetadata map[string]string
...
// The Kafka Connector configuration. The following properties cannot be set:
// connector.class, tasks.max.
type KafkaConnectorSpecConfig map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaConnectorSpec) UnmarshalJSON(b []byte) error {
...
// The connector status, as reported by the Kafka Connect REST API.
type KafkaConnectorStatusConnectorStatus map[string]string
