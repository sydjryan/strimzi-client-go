...
type KafkaMirrorMakerMetadata map[string]string
...
type KafkaMirrorMakerSpecConsumerConfig map[string]string
...
func (j *KafkaMirrorMakerSpecConsumer) UnmarshalJSON(b []byte) error {
	...
	if _, ok := raw["groupId"]; raw != nil && !ok {
	...
	if plain.NumStreams != nil && 1 > *plain.NumStreams {
		return fmt.Errorf("field %s: must be >= %v", "numStreams", 1)
	}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMakerSpecJvmOptions) UnmarshalJSON(b []byte) error {
	type Plain KafkaMirrorMakerSpecJvmOptions
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	...
	*j = KafkaMirrorMakerSpecJvmOptions(plain)
	return nil
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMakerSpecLivenessProbe) UnmarshalJSON(b []byte) error {
	type Plain KafkaMirrorMakerSpecLivenessProbe
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	...
	*j = KafkaMirrorMakerSpecLivenessProbe(plain)
	return nil
}
...
// ssl.protocol, ssl.enabled.protocols).
type KafkaMirrorMakerSpecProducerConfig map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMakerSpecReadinessProbe) UnmarshalJSON(b []byte) error {
	type Plain KafkaMirrorMakerSpecReadinessProbe
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	...
	*j = KafkaMirrorMakerSpecReadinessProbe(plain)
	return nil
}
...
type KafkaMirrorMakerSpecResourcesLimits map[string]string

type KafkaMirrorMakerSpecResourcesRequests map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMakerSpecTemplatePodDisruptionBudget) UnmarshalJSON(b []byte) error {
	type Plain KafkaMirrorMakerSpecTemplatePodDisruptionBudget
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	...
	*j = KafkaMirrorMakerSpecTemplatePodDisruptionBudget(plain)
	return nil
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMakerSpecTemplatePod) UnmarshalJSON(b []byte) error {
	type Plain KafkaMirrorMakerSpecTemplatePod
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	...
	*j = KafkaMirrorMakerSpecTemplatePod(plain)
	return nil
}
...
func (j *KafkaMirrorMakerSpec) UnmarshalJSON(b []byte) error {
	...
	if _, ok := raw["consumer"]; raw != nil && !ok {
