...
type KafkaNodePoolMetadata map[string]string
...
func (j *KafkaNodePoolSpecJvmOptions) UnmarshalJSON(b []byte) error {
...
type KafkaNodePoolSpecResourcesLimits map[string]string

type KafkaNodePoolSpecResourcesRequests map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaNodePoolSpecTemplatePod) UnmarshalJSON(b []byte) error {
