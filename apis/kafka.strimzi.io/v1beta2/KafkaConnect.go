...
type KafkaConnectMetadata map[string]string
...
func (j *KafkaConnectSpecBuildPluginsElemArtifactsElem) UnmarshalJSON(b []byte) error {
	...
	if plain.Url != nil {
		if matched, _ := regexp.MatchString("^(https?|ftp)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]$", string(*plain.Url)); !matched {
			return fmt.Errorf("field %s pattern match: must match %s", "^(https?|ftp)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]$", "Url")
		}
	}
...
func (j *KafkaConnectSpecBuildPluginsElem) UnmarshalJSON(b []byte) error {
	...
	if matched, _ := regexp.MatchString("^[a-z0-9][-_a-z0-9]*[a-z0-9]$", string(plain.Name)); !matched {
		return fmt.Errorf("field %s pattern match: must match %s", "^[a-z0-9][-_a-z0-9]*[a-z0-9]$", "Name")
	}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaConnectSpecJvmOptions) UnmarshalJSON(b []byte) error {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaConnectSpecLivenessProbe) UnmarshalJSON(b []byte) error {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaConnectSpecReadinessProbe) UnmarshalJSON(b []byte) error {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaConnectSpecTemplateBuildPod) UnmarshalJSON(b []byte) error {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaConnectSpecTemplatePodDisruptionBudget) UnmarshalJSON(b []byte) error {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaConnectSpecTemplatePod) UnmarshalJSON(b []byte) error {
